...
<div className="flex flex-col gap-6 items-start sm:flex-row">
  <div className="flex items-center gap-4 sm:flex-col">
    <img
      ...
      height="320"
      loading="lazy"
      src="../../MBbIYVtmB095.app/_astro/O3sWkEd6e30o.webp"
      width="320"
      className="rounded-lg h-24 max-w-none md:h-52 md:w-52 sm:h-36 sm:w-36 w-24 object-cover"
    />
    <a
      href="/cv.pdf"
  ...
  <div className="flex flex-col w-full gap-5">
    <div className="flex flex-col w-full gap-2 justify-between sm:flex-row">
      <div className="w-full">
        <h1
          className="text-gray-900 dark:text-gray-100 font-extrabold text-3xl sm:text-4xl"
        >
          Mark Freeman
        </h1>
        <h2
          className="font-medium text-gray-700 dark:text-gray-100 sm:text-lg text-base"
        >
    ...
    <div className="flex flex-col gap-6">
      <div className="inline-grid xl:grid-cols-[auto_auto]">
        ...
        <div>
          ...
          >
          <a
            href="mailto:mark.freeman.dev@gmail.com"
            className="dark:text-gray-300 text-sm font-normal text-gray-500 leading-relaxed sm:leading-relaxed sm:text-base underline"
            target="_self"
            >mark.freeman.dev@gmail.com</a
          >
        </div>
        <div>
          <span
